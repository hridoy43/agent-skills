...
- When no stack is specified, choose the Better-T-Stack configuration from confirmed requirements; ask the user only when materially different compatible choices or unresolved architecture tradeoffs require a decision. Do not ask the user to select every scaffold flag.
