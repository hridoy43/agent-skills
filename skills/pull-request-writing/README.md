...
Invoke `$pull-request-writing` with the repository path and review request. Add the base branch, ticket or issue link, review platform, project template, deployment context, and any screenshots when known.
